...
import { CirclePlus, Code, Frame, Layers3, Loader, Palette, School, Search, SquarePen } from "lucide-react";
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
    ...
    return (
        <>
            ...
            <AlertDialog open={isJoin}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        <AlertDialogTitle>Join Classroom</AlertDialogTitle>
                        <AlertDialogDescription></AlertDialogDescription>
                        <div className="">
                            <div className="flex justify-start items-center space-x-1 text-gray-600">
                                <Code size={20} />
            ...
            <div className="relative grid w-full">
                <div className="z-20 fixed pl-2 md:right-4 flex bg-background/70 backdrop-filter backdrop-blur-md">
                    <div className="flex justify-center items-center">
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger className="p-1 bg-primary/90 text-gray-200 rounded-r-md  backdrop-filter backdrop-blur-md hover:text-gray-200 hover:bg-primary">
                ...
                {/* show  card Class dashborad */}
                {/* <div className="overflow-x-auto"> */}
                <div className="flex flex-wrap gap-4 mt-12 p-4 justify-center">
                    <Card className="w-72 bg-primary/5 cursor-pointer hover:bg-primary/10">
                        <CardHeader>
                            <CardTitle className="text-xl">ห้องเรียนที่สร้าง</CardTitle>
                            <CardDescription className="text-sm">เป็นห้องเรียนที่คุณสร้าง</CardDescription>
                        </CardHeader>
                        <CardContent className="flex justify-center content-center">
                            <CirclePlus className="text-primary" size={100} />
                        </CardContent>
                        <CardFooter>
                            <p>จำนวน 100 ห้องเรียน</p>
                        </CardFooter>
                    </Card>
                    <Card className="w-72 bg-primary/5 cursor-pointer hover:bg-primary/10">
                        <CardHeader>
                            <CardTitle className="text-xl">ห้องเรียนที่เข้าร่วม</CardTitle>
                            <CardDescription className="text-sm">เป็นห้องเรียนที่คุณเข้าร่วม</CardDescription>
                        </CardHeader>
                        <CardContent className="flex justify-center content-center">
                            <School className="text-green-600" size={100} />
                        </CardContent>
                        <CardFooter>
                            <p>จำนวน 100 ห้องเรียน</p>
                        </CardFooter>
                    ...
                    <Card className="w-72 bg-primary/5 cursor-pointer hover:bg-primary/10">
                        <CardHeader>
                            <CardTitle className="text-xl">ห้องเรียนที่ยังไม่เข้าร่วม</CardTitle>
                            <CardDescription className="text-sm">เป็นห้องเรียนที่รอการอนุมัติให้เข้าร่วม</CardDescription>
                        </CardHeader>
                        <CardContent className="flex justify-center content-center">
                            <SquarePen className="text-yellow-600" size={100} />
                        </CardContent>
                        <CardFooter>
                            <p>จำนวน 100 ห้องเรียน</p>
                        </CardFooter>
                ...
                <div className="overflow-x-auto snap-x">
                    <div className="flex flex-wrap gap-4 mt-1 p-4">
                        {classroomData
                            .filter((cls) =>
